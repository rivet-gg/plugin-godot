...
static func set_default_setting_value(
	name: String,
	default_value: Variant,
	settings: EditorSettings = EditorInterface.get_editor_settings()
) -> void:
...
static func set_setting_value(
	name: String, value: Variant, settings: EditorSettings = EditorInterface.get_editor_settings()
) -> void:
